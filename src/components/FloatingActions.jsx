...
export default function FloatingActions() {
  ...
  return (
    <div className={styles.floatingContainer}>
      <a href="tel:+919876543210" className={`${styles.actionBtn} ${styles.callBtn}`} aria-label={t('callUs')}>
      ...
      <a href="https://wa.me/919876543210" target="_blank" rel="noopener noreferrer" className={`${styles.actionBtn} ${styles.waBtn}`} aria-label={t('chatWhatsapp')}>
        <span className={styles.icon}>
